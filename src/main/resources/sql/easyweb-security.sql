...
MySQL - 8.0.15 : Database - easyweb-security
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`easyweb-security` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

USE `easyweb-security`;
...
CREATE TABLE `sys_menu` (
  ...
  `path` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单路由关键字',
  `component` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单组件地址',
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单';

/*Data for the table `sys_menu` */

insert  into `sys_menu`(`menu_id`,`parent_id`,`menu_name`,`menu_icon`,`path`,`menu_type`,`sort_number`,`authority`,`target`,`hide`,`component`,`deleted`,`create_time`,`update_time`) values (1,0,'系统管理','layui-icon layui-icon-set-sm','',0,1,'','_self',0,'',0,'2020-02-26 12:51:23','2020-03-28 17:05:10'),(2,1,'用户管理',NULL,'#/system/user',0,1,'sys:user:view','_self',0,NULL,0,'2020-02-26 12:51:55','2020-03-28 16:27:20'),(3,2,'查询用户','','',1,1,'sys:user:list','_self',0,'',0,'2020-02-26 12:52:06','2020-03-28 17:05:19'),(4,2,'添加用户',NULL,NULL,1,2,'sys:user:save','_self',0,NULL,0,'2020-02-26 12:52:26','2020-03-21 18:45:29'),(5,2,'修改用户',NULL,NULL,1,3,'sys:user:update','_self',0,NULL,0,'2020-02-26 12:52:50','2020-03-21 18:45:30'),(6,2,'删除用户',NULL,NULL,1,4,'sys:user:remove','_self',0,NULL,0,'2020-02-26 12:53:13','2020-03-21 18:45:32'),(7,1,'角色管理',NULL,'#/system/role',0,2,'sys:role:view','_self',0,NULL,0,'2020-03-13 13:29:08','2020-03-28 16:27:23'),(8,7,'查询角色',NULL,NULL,1,1,'sys:role:list','_self',0,NULL,0,'2020-03-13 13:30:41','2020-03-21 18:45:34'),(9,7,'添加角色',NULL,NULL,1,2,'sys:role:save','_self',0,NULL,0,'2020-03-15 13:02:07','2020-03-21 18:45:35'),(10,7,'修改角色',NULL,NULL,1,3,'sys:role:update','_self',0,NULL,0,'2020-03-15 13:02:49','2020-03-21 18:45:36'),(11,7,'删除角色',NULL,NULL,1,4,'sys:role:remove','_self',0,NULL,0,'2020-03-20 17:58:51','2020-03-21 18:45:38'),(12,1,'菜单管理',NULL,'#/system/menu',0,3,'sys:menu:view','_self',0,NULL,0,'2020-03-21 01:07:13','2020-03-28 16:27:26'),(13,12,'查询菜单',NULL,NULL,1,1,'sys:menu:list','_self',0,NULL,0,'2020-03-21 16:43:30','2020-03-21 18:45:40'),(14,12,'添加菜单',NULL,NULL,1,2,'sys:menu:save','_self',0,NULL,0,'2020-03-21 16:43:54','2020-03-21 18:45:41'),(15,12,'修改菜单',NULL,NULL,1,3,'sys:menu:update','_self',0,NULL,0,'2020-03-21 18:24:17','2020-03-21 18:45:43'),(16,12,'删除菜单',NULL,NULL,1,4,'sys:menu:remove','_self',0,NULL,0,'2020-03-21 18:24:18','2020-03-21 18:45:44'),(17,1,'机构管理',NULL,'#/system/organization',0,4,'sys:org:view','_self',0,NULL,0,'2020-03-21 18:24:20','2020-03-28 16:27:29'),(18,17,'查询机构',NULL,NULL,1,1,'sys:org:list','_self',0,NULL,0,'2020-03-21 18:24:21','2020-03-21 18:44:36'),(19,17,'添加机构',NULL,NULL,1,2,'sys:org:save','_self',0,NULL,0,'2020-03-21 18:24:22','2020-03-21 18:45:51'),(20,17,'修改机构',NULL,NULL,1,3,'sys:org:update','_self',0,NULL,0,'2020-03-21 18:24:24','2020-03-21 18:45:52'),(21,17,'删除机构',NULL,NULL,1,4,'sys:org:remove','_self',0,NULL,0,'2020-03-21 18:24:25','2020-03-21 18:45:54'),(22,1,'字典管理',NULL,'#/system/dictionary',0,5,'sys:dict:view','_self',0,NULL,0,'2020-03-21 18:24:26','2020-03-28 16:28:48'),(23,22,'查询字典',NULL,NULL,1,1,'sys:dict:list','_self',0,NULL,0,'2020-03-21 18:24:27','2020-03-21 18:44:42'),(24,22,'添加字典',NULL,NULL,1,2,'sys:dict:save','_self',0,NULL,0,'2020-03-21 18:24:28','2020-03-21 18:45:59'),(25,22,'修改字典',NULL,NULL,1,3,'sys:dict:update','_self',0,NULL,0,'2020-03-21 18:24:29','2020-03-21 18:46:01'),(26,22,'删除字典',NULL,NULL,1,4,'sys:dict:remove','_self',0,NULL,0,'2020-03-21 18:24:31','2020-03-21 18:46:02'),(27,0,'日志管理','layui-icon layui-icon-list',NULL,0,2,NULL,'_self',0,NULL,0,'2020-03-21 18:24:32','2020-03-21 18:46:07'),(28,27,'登录日志',NULL,'#/system/login-record',0,1,'sys:login_record:view','_self',0,NULL,0,'2020-03-21 18:24:33','2020-03-28 16:28:18'),(29,27,'操作日志',NULL,'#/system/oper-record',0,2,'sys:oper_record:view','_self',0,NULL,0,'2020-03-21 18:24:34','2020-03-28 16:28:12'),(30,27,'数据监控',NULL,'#/druid',0,3,NULL,'_self',0,'druid',0,'2020-03-21 18:24:35','2020-03-28 12:29:11'),(31,0,'系统工具','layui-icon layui-icon-slider',NULL,0,3,NULL,'_self',0,NULL,0,'2020-03-21 18:24:36','2020-03-22 14:47:49'),(32,31,'文件管理',NULL,'#/system/file-manage',0,1,'sys:file:view','_self',0,NULL,0,'2020-03-21 18:24:38','2020-03-28 16:28:05'),(33,32,'查询文件',NULL,NULL,1,1,'sys:file:list','_self',0,NULL,0,'2020-03-21 18:24:39','2020-03-22 14:47:32'),(34,32,'删除文件',NULL,NULL,1,2,'sys:file:remove','_self',0,NULL,0,'2020-03-21 18:24:40','2020-03-22 14:46:54'),(35,31,'发送邮件',NULL,'#/system/email',0,2,'sys:email:view','_self',0,NULL,0,'2020-03-21 18:24:41','2020-03-28 16:27:47'),(36,31,'项目生成',NULL,NULL,0,3,NULL,'_self',0,NULL,0,'2020-03-21 18:24:42','2020-03-22 14:47:36'),(37,31,'接口文档',NULL,'#/swagger',0,4,NULL,'_self',0,'swagger-ui.html',0,'2020-03-28 12:20:52','2020-03-28 12:28:46');
...
insert  into `sys_user`(`user_id`,`username`,`password`,`nick_name`,`avatar`,`sex`,`phone`,`email`,`email_verified`,`true_name`,`id_card`,`birthday`,`organization_id`,`state`,`introduction`,`deleted`,`create_time`,`update_time`) values (1,'admin','$2a$10$QbAbiMqWF/1g4K6CMxJD8.qZPTcWQKoQaylnJS3o55cUq/Dx8/vem','管理员',NULL,1,'','',0,NULL,NULL,NULL,NULL,0,NULL,0,'2020-01-13 14:43:52','2020-03-28 12:36:36');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='用户角色';
